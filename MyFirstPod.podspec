...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Anh Tu/MyFirstPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Anh Tu' => 'at.mrsteven@gmail.com' }
  s.source           = { :git => 'https://github.com/Anh Tu/MyFirstPod.git', :tag => s.version.to_s }
